...
+ (NSString *)hexStringFromString:(NSString *)string {
  ...
  {
    NSString *newHexStr =
        [NSString stringWithFormat:@"%x", bytes[i] & 0xff]; /// 16進制數
...
+ (NSString *)stringWithHexNumber:(NSUInteger)hexNumber {
  ...
  NSString *hexString = [NSString stringWithCString:hexChar
...
+ (NSString *)getTimeStringWithTimeData:(NSInteger)timeData;
{
  ...
  timeStr =
      [data stringFromDate:[NSDate dateWithTimeIntervalSince1970:timeData]];
  return timeStr;
}
...
- (NSMutableArray *)fetchTagEPCStrWithTagCoutStr:(NSString *)tagCountStr
  ...
  if ([tagCountStr isEqualToString:@"1"]) {
    // 返回1個標籤
    NSString *epc =
        [epcStr substringWithRange:NSMakeRange(2, epcStr.length - 2)];
    BOOL isHave = NO;
    ...
    NSString *str1 = [BluetoothUtil
        becomeNumberWith:[epcStr substringWithRange:NSMakeRange(0, 2)]];
    NSString *epc1 =
        [epcStr substringWithRange:NSMakeRange(2, str1.integerValue * 2)];
    NSString *str2 = [BluetoothUtil
        becomeNumberWith:[epcStr
                             substringWithRange:NSMakeRange(
                                                    str1.integerValue * 2 + 2,
                                                    2)]];
    NSString *epc2 =
        [epcStr substringWithRange:NSMakeRange(str1.integerValue * 2 + 4,
                                               str2.integerValue * 2)];
    BOOL isHave = NO;
    for (NSInteger i = 0; i < dataSource.count; i++) {
      NSString *str = dataSource[i];
    ...
    if (isHave1 == NO) {
      ...
      [countArr addObject:@"1"];
                 ...
                 isEqualToString:@"3"]) { // c88c0032e1 0000 03 0c
                                          // e20051578818015726600b06 0c
                                          // e20051578818015727200883 0c
                                          // 889951578818015725601379 e5 0d0a
    // 返回3個標籤
    NSString *str1 = [BluetoothUtil
        becomeNumberWith:[epcStr substringWithRange:NSMakeRange(0, 2)]];
    NSString *epc1 =
    ...
    NSString *str3 = [BluetoothUtil
        becomeNumberWith:[epcStr
                             substringWithRange:NSMakeRange(
                                                    ...
                                                    2)]];
    NSString *epc3 =
        [epcStr substringWithRange:NSMakeRange(str1.integerValue * 2 +
                                                   str2.integerValue * 2 + 6,
                                               str3.integerValue * 2)];
    ...
    if (isHave2 == NO) {
      ...
      [countArr addObject:@"1"];
                 ...
                 isEqualToString:@"4"]) { // c88c0032e1 0000 03 0c
                                          // e20051578818015726600b06 0c
                                          // e20051578818015727200883 0c
                                          // 889951578818015725601379 0c
                                          // 889951578818015725601379 e5 0d0a
    // 返回4個標籤
    NSString *str1 = [BluetoothUtil
        becomeNumberWith:[epcStr substringWithRange:NSMakeRange(0, 2)]];
    ...
    if (isHave3 == NO) {
      ...
      [countArr addObject:@"1"];
                 ...
                 isEqualToString:@"5"]) { // c88c0032e1 0000 03 0c
                                          // e20051578818015726600b06 0c
                                          // e20051578818015727200883 0c
                                          // 889951578818015725601379 0c
                                          // 889951578818015725601379 e5 0d0a
    ...
    if (isHave4 == NO) {
      ...
      [countArr addObject:@"1"];
                 ...
                 isEqualToString:@"6"]) { // c88c0032e1 0000 03 0c
                                          // e20051578818015726600b06 0c
                                          // e20051578818015727200883 0c
                                          // 889951578818015725601379 0c
                                          // 889951578818015725601379 e5 0d0a
    ...
    if (isHave5 == NO) {
      ...
      [countArr addObject:@"1"];
                 ...
                 isEqualToString:@"7"]) { // c88c0032e1 0000 03 0c
                                          // e20051578818015726600b06 0c
                                          // e20051578818015727200883 0c
                                          // 889951578818015725601379 0c
                                          // 889951578818015725601379 e5 0d0a
    ...
    if (isHave6 == NO) {
      ...
      [countArr addObject:@"1"];
                 ...
                 isEqualToString:@"8"]) { // c88c0032e1 0000 03 0c
                                          // e20051578818015726600b06 0c
                                          // e20051578818015727200883 0c
                                          // 889951578818015725601379 0c
                                          // 889951578818015725601379 e5 0d0a
...
// 解析標籤
+ (NSMutableArray *)getLabTagWith:(NSString *)tagStr
                       dataSource:(NSMutableArray *)dataSource
                         countArr:(NSMutableArray *)countArr {
  ...
  if (tagStr.length > 28) {
    NSString *epcStr =
        [tagStr substringWithRange:NSMakeRange(16, tagStr.length - 16 - 6)];
    ...
    for (NSInteger i = 0; i < tagCountDec; i++) {
      ...
      NSInteger decimalEPCLong =
          [AppHelper getDecimalByBinary:[AppHelper getBinaryByHex:epcLength]];
      NSString *epcDataStr =
          [epcStr substringWithRange:NSMakeRange(2, decimalEPCLong * 2)];
      BOOL isHave = NO;
    ...
    allArr = [[self shareManager] fetchTagEPCStrWithTagCoutStr:tagCountStr
                                                        epcStr:epcStr
...
- (NSString *)AnalysisEPCDataWithEPCData:(NSString *)EPCData {
  if (EPCData.length > 2) {
    ...
    // NSInteger decimalEPCLong = [AppHelper getDecimalByBinary:[AppHelper
    // getBinaryByHex:epcDataLong]]; NSString *currentEPCData = [EPCData
    // substringToIndex:(decimalEPCLong + 1) * 2];
    ...
    if (EPCData.length < (3 * 2 + EPCRealDataLong * 2 * 2 + 2 * 2)) {
      for (NSInteger i = EPCData.length;
           EPCData.length < (3 * 2 + EPCRealDataLong * 2 * 2 + 2 * 2); i++) {
...
- (NSString *)analysisEPCAndTIDWithEPCAndTIDData:(NSString *)data {
  if (data.length > 2) {
    ...
    if (data.length < (3 * 2 + realDataLong * 2 * 2 + 12 * 2 + 2 * 2)) {
      for (NSInteger i = data.length;
           i < (3 * 2 + realDataLong * 2 * 2 + 12 * 2 + 2 * 2); i++) {
        data = [data stringByAppendingString:@"0"];
      }
    }
    NSString *tidStr =
        [data substringWithRange:NSMakeRange(3 * 2 + realDataLong * 2 * 2,
                                             12 * 2 + 2 * 2)]; //  添加了RSSI
    NSString *EPCAndTidStr = [NSString
        stringWithFormat:@"%@+%@",
                         [data substringWithRange:NSMakeRange(3 * 2,
                                                              realDataLong * 2 *
                                                                  2)],
                         tidStr];
    return EPCAndTidStr;
...
- (NSString *)analysisEPCAndTidAndUserDataWithData:(NSString *)data {
  if (data.length > 2) {
    ...
    //  獲取EPC數據
    NSString *EPCRealStr =
        [data substringWithRange:NSMakeRange(3 * 2, realEPCDataLong * 2 * 2)];
    if (data.length <
        (3 * 2 + realEPCDataLong * 2 * 2 + 12 * 2 +
         (data.length - (3 * 2 + realEPCDataLong * 2 * 2 + 12 * 2)))) {
      for (NSInteger i = 0;
           i < (3 * 2 + realEPCDataLong * 2 * 2 + 12 * 2 +
                (data.length - (3 * 2 + realEPCDataLong * 2 * 2 + 12 * 2)));
           i++) {
        data = [data stringByAppendingString:@"0"];
      }
    ...
    NSString *tidStr =
        [data substringWithRange:NSMakeRange(3 * 2 + realEPCDataLong * 2 * 2,
                                             12 * 2)];
    //  獲取USER數據
    NSString *userDataStr = [data
        substringWithRange:NSMakeRange(3 * 2 + realEPCDataLong * 2 * 2 + 12 * 2,
                                       data.length -
                                           (3 * 2 + realEPCDataLong * 2 * 2 +
                                            12 * 2))]; //  添加了 RSSI
    return [NSString
        stringWithFormat:@"%@+%@+%@", EPCRealStr, tidStr, userDataStr];
  }
  return @"";
}

// 解析標籤2
+ (NSMutableArray *)getNewLabTagWith:(NSString *)tagStr
                          dataSource:(NSMutableArray *)dataSource
                            countArr:(NSMutableArray *)countArr
                           ...
                           countArr2:(NSMutableArray *)countArr2;
{
  ...
  // c88c 00 62 e1 00 00
  // 03
  // 1c 3000 e2 00 00 17 01 0b 01 93 17 50 62 97    e2 00 34 12 01 2f fc 00 0b
  // 45 e5 7d  fdb9 1c 3000 e2 00 00 17 01 0b 01 91 17 50 62 96    e2 00 34 12
  // 01 34 fc 00 0b 45 e5 7c  fdcc 1c 3000 e2 00 00 17 01 0b 00 80 17 50 61 af
  // e2 00 34 12 01 37 fc 00 0b 45 e4 95  fd39 c30d0a

  // c88c 00 5d e1 00 02
  // 02
  // 28 3000 e2 00 00 17 01 0b 02 11 17 50 62 b8    e2 00 34 12 01 2c fc 00 0b
  // 45 e5 9e    00 00 00 00 00 00 00 00 00 00 00 00 fd40 28 3000 e2 00 00 17 01
  // 0b 01 93 17 50 62 97    e2 00 34 12 01 2f fc 00 0b 45 e5 7d
  // 000000000000000000000000 fdb1 030d0a
  ...
  NSInteger countStr1 = [AppHelper
      getDecimalByBinary:[AppHelper
                             getBinaryByHex:[tagStr
                                                substringWithRange:NSMakeRange(
                                                                       16,
                                                                       2)]]];
  ...
  if ([typeStr isEqualToString:@"0"]) {
    ...
    if (tagCountStr.integerValue >= 1) {
      for (NSInteger i = 0; i < tagCountStr.integerValue; i++) {
        ...
        NSInteger decimalEPCLong = [AppHelper
            getDecimalByBinary:[AppHelper getBinaryByHex:epcDataLong]];
        NSString *currentEPCData =
            [epcStr substringToIndex:(decimalEPCLong + 1) * 2];
        NSString *epcRealStr =
            [[self shareManager] AnalysisEPCDataWithEPCData:currentEPCData];
        BOOL isHave = NO;
        for (NSInteger j = 0; j < dataSource.count; j++) {
          NSString *str = dataSource[j];
    ...
    // c88c 00 62 e1 00 00
    // 03
    // 1c 30 00 e2 00 00 17 01 0b 01 93 17 50 62 97    e2 00 34 12 01 2f fc 00
    // 0b 45 e5 7d  fdb9 1c 3000 e2 00 00 17 01 0b 01 91 17 50 62 96    e2 00 34
    // 12 01 34 fc 00 0b 45 e5 7c  fdcc 1c 3000 e2 00 00 17 01 0b 00 80 17 50 61
    // af    e2 00 34 12 01 37 fc 00 0b 45 e4 95  fd39 c30d0a
    for (NSInteger i = 0; i < tagCountStr.integerValue; i++) {
      NSString *epcDataLong = [epcStr substringToIndex:2];
      NSInteger decimalEPCLong =
          [AppHelper getDecimalByBinary:[AppHelper getBinaryByHex:epcDataLong]];
      NSString *currentEPCData =
          [epcStr substringToIndex:(decimalEPCLong + 1) * 2];
      NSString *EPCAndTidStr = [[self shareManager]
          analysisEPCAndTIDWithEPCAndTIDData:currentEPCData];
      if (EPCAndTidStr && EPCAndTidStr.length > 12) {
        if ([EPCAndTidStr containsString:@"+"]) {
          NSArray *epcAndTidStrArr =
              [EPCAndTidStr componentsSeparatedByString:@"+"];
    ...
    for (NSInteger i = 0; i < tagCountStr.integerValue; i++) {
      ...
      NSString *currentEPCData =
          [epcStr substringToIndex:(decimalEPCLong + 1) * 2];
      NSString *epcAndTidAndUserData = [[self shareManager]
          analysisEPCAndTidAndUserDataWithData:currentEPCData];
      if (epcAndTidAndUserData && epcAndTidAndUserData.length > 12) {
        if ([epcAndTidAndUserData containsString:@"+"]) {
          NSArray *allDataArr =
              [epcAndTidAndUserData componentsSeparatedByString:@"+"];
...
// 設置標籤讀取格式
+ (NSData *)setEpcTidUserWithAddressStr:(NSString *)addressStr
  ...
  dateByte[9] =
      0x00 ^ 0x0C ^ 0x70 ^ 0x00 ^ dateByte[6] ^ dateByte[7] ^ dateByte[8];
  dateByte[10] = 0x0D;
  dateByte[11] = 0x0A;
...
// 設置發射功率
+ (NSData *)setLaunchPowerWithstatus:(NSString *)status
  ...
  dateByte[11] = 0x00 ^ 0x0E ^ 0x10 ^ dateByte[5] ^ dateByte[6] ^ dateByte[7] ^
                 dateByte[8] ^ dateByte[9] ^ dateByte[10];
  dateByte[12] = 0x0D;
  dateByte[13] = 0x0A;
...
+ (NSData *)detailChancelSettingWithstring:(NSString *)str {
  ...
  NSInteger dd =
      aa % (16 * 16 * 16 * 16 * 16) % (16 * 16 * 16 * 16) / (16 * 16 * 16);
  NSInteger ee = aa % (16 * 16 * 16 * 16 * 16) % (16 * 16 * 16 * 16) %
                 (16 * 16 * 16) / (16 * 16);
  NSInteger ff = aa % (16 * 16 * 16 * 16 * 16) % (16 * 16 * 16 * 16) %
                 (16 * 16 * 16) % (16 * 16) / 16;
  NSInteger gg = aa % (16 * 16 * 16 * 16 * 16) % (16 * 16 * 16 * 16) %
                 (16 * 16 * 16) % (16 * 16) % 16;
  ...
  dateByte[9] = 0x00 ^ 0x0C ^ 0x14 ^ dateByte[5] ^ dateByte[6] ^ dateByte[7] ^
                dateByte[8];
  dateByte[10] = 0x0D;
  dateByte[11] = 0x0A;
  NSData *data = [[NSData alloc] initWithBytes:dateByte length:12];
...
// 區域設置
+ (NSData *)setRegionWithsaveStr:(NSString *)saveStr
...
// 讀標籤數據區
+ (NSData *)readLabelMessageWithPassword:(NSString *)password
  ...
  if (isfilter) {
    ...
    dateByte[19 + dataArr.count] = dateByte[2] ^ dateByte[3] ^ dateByte[4] ^
                                   dateByte[5] ^ dateByte[6] ^ dateByte[7] ^
                                   dateByte[8] ^ dateByte[9] ^ dateByte[10] ^
                                   dateByte[11] ^ dateByte[12] ^ dateByte[13];
    for (NSInteger i = 0; i < dataArr.count + 5; i++) {
      dateByte[19 + dataArr.count] =
          dateByte[19 + dataArr.count] ^ dateByte[i + 14];
    }

    dateByte[20 + dataArr.count] = 0x0D;
    dateByte[21 + dataArr.count] = 0x0A;
    NSData *data = [[NSData alloc] initWithBytes:dateByte
                                          length:22 + dataArr.count];
...
// 寫標籤數據區
+ (NSData *)writeLabelMessageWithPassword:(NSString *)password
                                   MMBstr:(NSString *)MMBstr
                                   MSAstr:(NSString *)MSAstr
                                   MDLstr:(NSString *)MDLstr
                                   MDdata:(NSString *)MDdata
  ...
  if (isfilter) {
    ...
    dateByte[19 + dataArr.count + writeArr.count] =
        dateByte[2] ^ dateByte[3] ^ dateByte[4] ^ dateByte[5] ^ dateByte[6] ^
        dateByte[7] ^ dateByte[8] ^ dateByte[9] ^ dateByte[10] ^ dateByte[11] ^
        dateByte[12] ^ dateByte[13];
    for (NSInteger i = 0; i < dataArr.count + 5 + writeArr.count; i++) {
      dateByte[19 + dataArr.count + writeArr.count] =
          dateByte[19 + dataArr.count + writeArr.count] ^ dateByte[i + 14];
    }

    dateByte[20 + dataArr.count + writeArr.count] = 0x0D;
    dateByte[21 + dataArr.count + writeArr.count] = 0x0A;
    NSData *data =
        [[NSData alloc] initWithBytes:dateByte
                               length:22 + dataArr.count + writeArr.count];
    NSLog(@"data===%@", data);
    return data;
  } else {
    ...
    for (NSInteger i = 0; i < 15 + writeArr.count; i++) {
      dateByte[19 + writeArr.count] =
          dateByte[19 + writeArr.count] ^ dateByte[i + 4];
    }
    dateByte[20 + writeArr.count] = 0x0D;
    dateByte[21 + writeArr.count] = 0x0A;
    NSData *data = [[NSData alloc] initWithBytes:dateByte
                                          length:22 + writeArr.count];
    NSLog(@"data===%@", data);
    return data;
  }
}
// kill標籤
+ (NSData *)killLabelWithPassword:(NSString *)password
                           MMBstr:(NSString *)MMBstr
                           MSAstr:(NSString *)MSAstr
                           MDLstr:(NSString *)MDLstr
                           MDdata:(NSString *)MDdata
  ...
  if (isfilter) {
    ...
    for (NSInteger i = 0; i < 10 + dataArr.count; i++) {
      dateByte[14 + dataArr.count] =
          dateByte[14 + dataArr.count] ^ dateByte[i + 4];
    }

    dateByte[15 + dataArr.count] = 0x0D;
    dateByte[16 + dataArr.count] = 0x0A;
    NSData *data = [[NSData alloc] initWithBytes:dateByte
                                          length:17 + dataArr.count];
    return data;
  } else {
    Byte dateByte[17];
    dateByte[0] = 0xC8;
...
// Lock標籤
+ (NSData *)lockLabelWithPassword:(NSString *)password
                           MMBstr:(NSString *)MMBstr
                           MSAstr:(NSString *)MSAstr
                           MDLstr:(NSString *)MDLstr
                           MDdata:(NSString *)MDdata
  ...
  if (isfilter) {
    ...
    for (NSInteger i = 0; i < 13 + dataArr.count; i++) {
      dateByte[17 + dataArr.count] =
          dateByte[17 + dataArr.count] ^ dateByte[i + 4];
    }

    dateByte[18 + dataArr.count] = 0x0D;
    dateByte[19 + dataArr.count] = 0x0A;
    NSData *data = [[NSData alloc] initWithBytes:dateByte
                                          length:20 + dataArr.count];
...
// 設置密鑰
+ (NSData *)setSM4PassWordWithmodel:(NSString *)model
...
// USER加密
+ (NSData *)encryptionUSERWithaddress:(NSString *)address
...
// USER解密
+ (NSData *)decryptUSERWithaddress:(NSString *)address
                         lengthStr:(NSString *)lengthStr {
  Byte dateByte[13];
  dateByte[0] = 0xC8;
  dateByte[1] = 0x8C;
  ...
  dateByte[10] = 0x00 ^ 0x0D ^ dateByte[4] ^ dateByte[5] ^ dateByte[6] ^
                 dateByte[7] ^ dateByte[8] ^ dateByte[9];
