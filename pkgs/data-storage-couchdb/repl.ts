...
import { GetData, GetDataCount, SaveDatum } from '@invt/data/types';
import { fixDataConsistency as uFixDataConsistency } from '@invt/data/utils';
...
import CouchDBData from './src/CouchDBData';
import {
  getDatumFromDoc,
  getDocFromDatum,
} from './src/functions/couchdb-utils';
